...
namespace GraderApplication
{
   ...
   {
   private:
      static const int maxStudentLength = LEN;
      std::string name;
      std::array <float, maxStudentLength> gradesContainer;
      float finalGrade;
   ...
   public:
      ...
      /* XXX: Documentation
       * getter for student length, 
       * this is a hardcoded value from
       * settings.h
       * */
      int getStudentLength(void) const;
